...
const UserSchema = CollectionSchema(
  ...
  links: {
    r'location': LinkSchema(
      id: -1147744247500197252,
      name: r'location',
      target: r'Location',
      single: true,
    ),
    r'treatments': LinkSchema(
      id: -2695883818950262422,
      name: r'treatments',
      target: r'Treatment',
      single: false,
    )
...
void _userSerialize(
  ...
  writer.writeString(offsets[2], object.whatsappNumber);
}
...
User _userDeserialize(
  ...
  object.whatsappNumber = reader.readStringOrNull(offsets[2]);
  return object;
}
...
List<IsarLinkBase<dynamic>> _userGetLinks(User object) {
  return [object.location, object.treatments];
}
...
extension UserQueryFilter on QueryBuilder<User, User, QFilterCondition> {
  ...
  QueryBuilder<User, User, QAfterFilterCondition> whatsappNumberIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNull(
  ...
  QueryBuilder<User, User, QAfterFilterCondition> whatsappNumberIsNotNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNotNull(
        property: r'whatsappNumber',
      ));
  ...
  QueryBuilder<User, User, QAfterFilterCondition> whatsappNumberEqualTo(
    String? value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<User, User, QAfterFilterCondition> whatsappNumberGreaterThan(
    String? value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<User, User, QAfterFilterCondition> whatsappNumberLessThan(
    String? value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<User, User, QAfterFilterCondition> whatsappNumberBetween(
    String? lower,
    String? upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<User, User, QAfterFilterCondition> whatsappNumberStartsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<User, User, QAfterFilterCondition> whatsappNumberEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<User, User, QAfterFilterCondition> whatsappNumberContains(
      String value,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.contains(
  ...
  QueryBuilder<User, User, QAfterFilterCondition> whatsappNumberMatches(
      String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.matches(
  ...
  QueryBuilder<User, User, QAfterFilterCondition> whatsappNumberIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'whatsappNumber',
        value: '',
  ...
  QueryBuilder<User, User, QAfterFilterCondition> whatsappNumberIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.greaterThan(
        property: r'whatsappNumber',
        value: '',
...
extension UserQueryLinks on QueryBuilder<User, User, QFilterCondition> {
  ...
  QueryBuilder<User, User, QAfterFilterCondition> treatments(
  ...
  QueryBuilder<User, User, QAfterFilterCondition> treatmentsLengthEqualTo(
      int length) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<User, User, QAfterFilterCondition> treatmentsIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.linkLength(r'treatments', 0, true, 0, true);
    });
  }

  QueryBuilder<User, User, QAfterFilterCondition> treatmentsIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.linkLength(r'treatments', 0, false, 999999, true);
    });
  }

  QueryBuilder<User, User, QAfterFilterCondition> treatmentsLengthLessThan(
    int length, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<User, User, QAfterFilterCondition> treatmentsLengthGreaterThan(
    int length, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<User, User, QAfterFilterCondition> treatmentsLengthBetween(
    int lower,
    int upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension UserQuerySortBy on QueryBuilder<User, User, QSortBy> {
  ...
  QueryBuilder<User, User, QAfterSortBy> sortByWhatsappNumber() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'whatsappNumber', Sort.asc);
    });
  }

  QueryBuilder<User, User, QAfterSortBy> sortByWhatsappNumberDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension UserQuerySortThenBy on QueryBuilder<User, User, QSortThenBy> {
  ...
  QueryBuilder<User, User, QAfterSortBy> thenByWhatsappNumber() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'whatsappNumber', Sort.asc);
    });
  }

  QueryBuilder<User, User, QAfterSortBy> thenByWhatsappNumberDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'whatsappNumber', Sort.desc);
    });
  }
...
extension UserQueryWhereDistinct on QueryBuilder<User, User, QDistinct> {
  ...
  QueryBuilder<User, User, QDistinct> distinctByWhatsappNumber(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension UserQueryProperty on QueryBuilder<User, User, QQueryProperty> {
  ...
  QueryBuilder<User, String?, QQueryOperations> whatsappNumberProperty() {
    return QueryBuilder.apply(this, (query) {
